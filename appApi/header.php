    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php" style="width: 152px;">
                <div class="sidebar-brand-text mx-3 text-center">SONGS EMI</div>
            </a>
            ...
            <!-- <li class="nav-item">
            <a class="nav-link" href="#" data-toggle="modal" data-target="#puntuar">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Buscar Regalo</span></a>
            </li> -->

            <li class="nav-item">
                <a class="nav-link" href="enrutador.php?accion=mostrarTop">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Canciones Top</span></a>
            </li>
