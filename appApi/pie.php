    ...
    <footer  >
      ...
      <div class="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
        <div class="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
          <h2 class="text-xs text-purple-500 tracking-widest font-medium title-font mb-1">Diseño web profesional</h2>
          <h1 class="md:text-xl text-md leading-6 text-center text-gray-400">© 2023 Emi Studios, Todos los derechos
            reservados</h1>
        </div>
